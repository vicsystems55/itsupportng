...
@section('content')
	...
	<section class="slider-two">
		<div class="single-item-carousel owl-carousel owl-theme">
			...
			<!-- Slide -->
			<div class="slide">
				<div class="slider-two_image-layer" style="background-image:url(images/main-slider/22.jpg)"></div>
				<div class="slider-two_pattern-layer" style="background-image:url(images/main-slider/pattern-1.png)"></div>
				<div class="auto-container">
	...
	<!-- Featured One -->
	<section class="featured-one d-none">
		<div class="auto-container">
	...
	<!-- Choose One -->
	<section class="choose-one d-none">
	...
	<!-- Pricing One -->
	<section class="pricing-one d-none">
