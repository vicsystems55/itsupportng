		...
		<div class="header-top_two d-none">
			<div class="auto-container">
				<div class="d-flex justify-content-center align-items-center flex-wrap">
					...
					<!-- Info List -->
					<ul class="info-list">
						<li><a href="#"><span class="icon fa-solid fa-phone fa-fw"></span>(+234) 902 555 3091</a></li>
						<li><a href="#"><span class="icon fa-solid fa-envelope fa-fw"></span>info@itsupportng.com</a></li>
						<li><a href="#"><span class="icon fa-solid fa-map fa-fw"></span>Setraco Quarters, Federal
                            Housing Authority, Gwarinpa</a></li>
					</ul>
